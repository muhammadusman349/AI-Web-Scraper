...
import openai
from src.api_keys import get_api_keys
from src.assets import (
            PROMPT_PAGINATION, PRICING,
...
def detect_pagination_elements(url: str, indications: str, selected_model: str, markdown_content: str) -> Tuple[Union[PaginationData, Dict, str], Dict, float]:
    try:
        ...
        if selected_model in ["gpt-4o-mini", "gpt-4o-2024-08-06"]:
            # Use OpenAI API
            client = OpenAI(api_key=get_api_keys('OPENAI_API_KEY'))
            ...
            genai.configure(api_key=get_api_keys("GOOGLE_API_KEY"))
            ...
            # Use Groq client
            client = Groq(api_key=get_api_keys("GROQ_API_KEY"))
